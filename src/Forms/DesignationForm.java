 ...
 * @author Adrian
 */
public class DesignationForm extends javax.swing.JFrame {
    ...
    private void updateTableData() {
        try {
            ...
            while (resultSet.next()) {
                ...
                tableModel.addRow(new Object[]{positionID, positionName});
            }
    ...
    private void initComponents() {
        ...
        MainPanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 380, 180));
        ...
        MainPanel.add(CloseFormBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 100, 40, 30));
        ...
        MainPanel.add(DeleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 100, 40, 30));
        ...
        MainPanel.add(UpdateTableBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 100, 40, 30));
        ...
        MainPanel.add(SaveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 40, 30));
        ...
        MainPanel.add(CreateNewBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, 40, 30));

        PositionTF.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        PositionTF.setEnabled(false);
        MainPanel.add(PositionTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 187, 30));

        PositionLabel.setText("Position:");
        MainPanel.add(PositionLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, -1, 30));

        FormTitle.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        FormTitle.setText("Designation Information");
    ...
    private void CreateNewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateNewBtnActionPerformed
        // TODO add your handling code here:
        this.PositionTF.setEnabled(true);
    ...
    private void DeleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtnActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            try {
                String positionName = tableModel.getValueAt(selectedRow, 1).toString();
                String query = "DELETE FROM positiondb WHERE positionName = ?";
                PreparedStatement statement = conn.prepareStatement(query);
                statement.setString(1, positionName);
                statement.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DesignationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
